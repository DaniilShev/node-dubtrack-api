...
class DubtrackAPI extends EventEmitter {
  ...
  getMutedUsers(roomId) {
    return this._request(replaceTemplates(endpoints.roomMutedUsers, {roomId}));
  }
  ...
  getBannedUsers(roomId) {
    return this._request(replaceTemplates(endpoints.roomBannedUsers, {roomId}));
  }
   ...
   */
  updateRoom(roomId) {
    let path = replaceTemplates(endpoints.room, {roomId});
  ...
  sendMessage(roomId, message) {
    let path = replaceTemplates(endpoints.sendMessage, {roomId});
  ...
  deleteMessage(roomId, messageId) {
    let path = replaceTemplates(endpoints.sendMessage, {roomId, messageId});
