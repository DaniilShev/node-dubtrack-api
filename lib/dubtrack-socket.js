...
/**
 * Handles Dubtrack websocket connections
 */
class DubtrackEvents {
  ...
  /**
   * Check whether the given channel is a presence channel
   * 
  ...
  /**
   * Reconnect websocket using new token
   * 
   * @private
   */
  _updateToken() {
  ...
  /**
   * Check whether websocket connection is established
   * 
   * @return {boolean}
   */
  isConnected() {
